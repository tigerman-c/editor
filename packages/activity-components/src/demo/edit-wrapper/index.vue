...
<template>
  <div
    ref="editWrapper" :data-component-id="id" class="edit-wrapper" :class="[active ? 'active' : '']"
    :style="{ ...commonStyle, ...styles }" @mousedown.stop="startMove" @click.stop="onItemClick(id)"
  >
    <slot />

    <div class="resizers">
      <div class="resizer top-left" @mousedown.stop="startResize('top-left')" />
      <div class="resizer top" @mousedown.stop="startResize('top')" />
      <div class="resizer top-right" @mousedown.stop="startResize('top-right')" />
      <div class="resizer right" @mousedown.stop="startResize('right')" />
      <div class="resizer bottom-left" @mousedown.stop="startResize('bottom-left')" />
      <div class="resizer bottom" @mousedown.stop="startResize('bottom')" />
      <div class="resizer bottom-right" @mousedown.stop="startResize('bottom-right')" />
      <div class="resizer left" @mousedown.stop="startResize('left')" />
    </div>
  </div>
</template>
