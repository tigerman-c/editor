...
import BaseComponents from '@editor/base-components'
import ActivityComponents from '@editor/activity-components'
...
import '@editor/base-components/style.css'
import '@editor/activity-components/style.css'
