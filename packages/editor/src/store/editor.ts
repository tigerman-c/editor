...
import type { ApiConfig, ApiType, ComponentData, RequestModules } from '@editor/global-types'
import { getApiData, initApiData } from '@editor/shared'
...
export const useEditorStore = defineStore('editor', {
  ...
  actions: {
    ...
    async saveWork(id: string) {
      console.log('%c [  ]-529', 'font-size:13px; background:pink; color:#bf2c9f;', {
